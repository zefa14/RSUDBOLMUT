...
<body>
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu shadow-sm" aria-labelledby="infoDropdown">
                            <li><a class="dropdown-item" href="#tim-dokter">Tim Dokter</a></li>
                            <li><a class="dropdown-item" href="#kamar">Fasilitas Kamar</a></li>
                            <li><a class="dropdown-item" href="#jadwal">Jadwal Pelayanan <i class="bi bi-calendar-event"></i></a></li>
    ...
    <section id="tim-dokter" class="welcome-section" style="background: white;">
        <div class="container" data-aos="fade-up">
            <div class="section-header text-center">
    ...
    <!-- Jadwal Poliklinik -->
    <section id="jadwal" class="welcome-section" style="background: var(--light);">
        <div class="container" data-aos="fade-up">
            <div class="section-header text-center">
    ...
    <section class="welcome-section" style="background: white;">
        <div class="container" data-aos="fade-up">
            <div class="section-header text-center">
                <span class="section-subtitle">Berita & Edukasi</span>
                <h2 class="section-title">Artikel Kesehatan Terkini</h2>
            </div>
            
            <div class="row g-4">
                @php
                    $beritaDefaults = [
                        ['title' => 'Tips Menjaga Kesehatan Jantung di Usia Muda', 'date' => '14 Mei 2026', 'desc' => 'Penyakit jantung tak lagi hanya menyerang usia lanjut. Kenali cara pencegahan sejak dini.', 'img' => 'https://images.unsplash.com/photo-1505576399279-565b52d4ac71?q=80&w=800&auto=format&fit=crop'],
                        ['title' => 'Pentingnya Vaksinasi Lengkap Pada Anak Balita', 'date' => '10 Mei 2026', 'desc' => 'Meningkatkan kekebalan tubuh anak adalah investasi terbaik untuk masa depan mereka.', 'img' => 'https://images.unsplash.com/photo-1584308666744-24d5e4a86f7b?q=80&w=800&auto=format&fit=crop'],
                        ['title' => 'Mengenal Gejala Awal Diabetes Melitus Tipe 2', 'date' => '05 Mei 2026', 'desc' => 'Waspadai tanda-tanda kecil yang sering diabaikan. Konsultasi segera jika Anda mengalaminya.', 'img' => 'https://images.unsplash.com/photo-1512069772995-ec65874c7604?q=80&w=800&auto=format&fit=crop'],
                    ];
                @endphp
                @for($i = 0; $i < 3; $i++)
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ ($i+1) * 100 }}">
                    <div class="article-card">
                        <img src="{{ $settings['berita_'.($i+1).'_img'] ?? $beritaDefaults[$i]['img'] }}" class="article-img" alt="Artikel">
                        <div class="article-content">
                            <span class="article-date">{{ $settings['berita_'.($i+1).'_date'] ?? $beritaDefaults[$i]['date'] }}</span>
                            <h4 class="article-title">{{ $settings['berita_'.($i+1).'_title'] ?? $beritaDefaults[$i]['title'] }}</h4>
                            <p class="text-muted small">{{ $settings['berita_'.($i+1).'_desc'] ?? $beritaDefaults[$i]['desc'] }}</p>
